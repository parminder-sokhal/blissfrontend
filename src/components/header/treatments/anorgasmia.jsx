...
const data = {
  bgImage: "/pictures/anorgasmai.jpeg", // Update if you have a specific image for Anorgasmia
  sidebarLinks: [
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-3/4 space-y-6 text-gray-700">
            ...
            <ul className="list-disc pl-6">
              <li>
                Primary Anorgasmia: Individuals have never experienced orgasm.
              </li>
              <li>
            ...
            <ul className="list-disc pl-6">
              <li>
                Stress and Anxiety: Performance anxiety or stress can inhibit
                sexual response.
              </li>
              <li>
                Depression: Mental health issues can significantly affect libido
                and function.
              </li>
              <li>
                Past Trauma: Sexual abuse or trauma can lead to difficulties in
                achieving orgasm.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6">
              <li>
                Hormonal Imbalances: Low testosterone or estrogen levels can
                impact sexual response.
              </li>
              <li>
                Chronic Illnesses: Diabetes, MS, or cardiovascular disease can
                interfere with sexual function.
              </li>
              <li>
                Neurological Disorders: These may affect the body’s ability to
                respond sexually.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6">
              <li>
                Antidepressants, especially SSRIs, can cause sexual dysfunction.
              </li>
              <li>
                Hormonal Treatments like birth control may also affect orgasm.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6">
              <li>
                Poor Communication: A lack of openness about sexual needs can
                cause problems.
              </li>
              <li>
                Emotional Disconnect: Conflict or unresolved issues can impact
                intimacy.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6">
              ...
              <li>
                Feelings of inadequacy or low self-esteem about sexual health.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6">
              <li>
                Strain in relationships due to unmet needs or expectations.
              </li>
            ...
            <ul className="list-disc pl-6">
              <li>
                Cognitive Behavioral Therapy (CBT): Addresses mental patterns
                and anxieties.
              </li>
              <li>
                Sex Therapy: Improves communication and intimacy with a partner.
              </li>
              <li>
                Mindfulness & Relaxation: Reduces stress and enhances presence
                in the moment.
              </li>
            </ul>
            ...
            <p>
              Regular physical activity, a healthy diet, and stress reduction
              techniques can improve overall well-being and sexual function.
            </p>

            <h3 className="font-semibold text-lg">4. Medication</h3>
            <p>
              In select cases, medications may be prescribed to address hormonal
            ...
            <ul className="list-disc pl-6">
              <li>
                Experienced Professionals: Specialists in sexual and mental
                health care.
              </li>
              <li>Holistic Approach: Addressing both mind and body.</li>
              <li>
                Confidential Environment: Your privacy and comfort come first.
              </li>
            </ul>
          </div>
