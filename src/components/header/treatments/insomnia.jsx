      ...
      <div className="px-10 lg:px-40 py-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-3/4 space-y-6 text-gray-700">
            ...
            <p>
              Insomnia is a sleep disorder involving difficulty falling or
              staying asleep, or waking up too early. It can be acute or
              chronic, and may lead to fatigue, irritability, poor
              concentration, and lowered productivity.
            </p>
            ...
            <p>
              <strong>Acute Insomnia:</strong> Usually triggered by stress or a
              life event and lasts a few days or weeks. <br />
              <strong>Chronic Insomnia:</strong> Occurs at least three times a
              week for three months or more, often due to medical or
            ...
            <p>
              We conduct a thorough consultation, review your medical and sleep
              history, and may use tools like sleep diaries and overnight
              studies to assess causes and patterns.
            </p>
            ...
            <p>
              Short-term or occasional use of sleep aids may be considered,
              tailored to your individual needs and health conditions.
            </p>
            ...
            <p>
              We guide you through practices such as meditation, breathing
              exercises, progressive muscle relaxation, and guided imagery to
              quiet the mind and body before bed.
            </p>
            ...
            <p>
              For circadian-related insomnia, we may use bright light therapy to
              reset your internal body clock.
            </p>

            <h2 className="text-xl font-semibold">
              Why Choose Our Sleep Clinic for Insomnia?
            </h2>
            <ul className="list-disc pl-6">
              <li>
                <strong>Experienced Specialists:</strong> Experts in diagnosing
                and managing sleep disorders.
              </li>
              <li>
                <strong>Personalized Care:</strong> Individualized plans based
                on your unique sleep challenges.
              </li>
              <li>
                <strong>Behavioral and Medical Integration:</strong> We combine
                the best of therapy and medical options.
              </li>
              <li>
                <strong>Technology-Driven:</strong> In-lab and home sleep
                studies available for detailed assessments.
              </li>
              <li>
                <strong>Ongoing Support:</strong> Continued care to ensure
                lasting results.
              </li>
            </ul>
          </div>
