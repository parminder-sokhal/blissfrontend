      ...
      <div className="px-10 lg:px-40 py-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-3/4 space-y-6 text-gray-700">
            ...
            <p>
              Social Skills Training (SST) is a structured form of therapy
              designed to help individuals improve their ability to interact
              effectively and appropriately with others. It focuses on
              developing communication, relationship-building, and interpersonal
              skills that are essential in daily life—whether at work, school,
              home, or in social settings.
            </p>
            <p>
              Social skills are learned behaviors. Just like any other skill,
              they can be taught, practiced, and improved with the right
              guidance and support. SST is especially useful for individuals who
              find social interaction challenging due to developmental
              conditions, anxiety, or past experiences.
            </p>
            ...
            <p>
              SST sessions are goal-oriented and typically involve structured
              activities led by a trained therapist. Sessions may be conducted
              individually or in groups, depending on the client’s needs and
              preferences.
            </p>
            <ul className="list-disc pl-6">
              <li>
                <strong>Assessment of Current Skills</strong> – Therapist
                evaluates social functioning and target areas.
              </li>
              <li>
                <strong>Skill Teaching and Modeling</strong> – New behaviors are
                taught and demonstrated.
              </li>
              <li>
                <strong>Role-Playing</strong> – Practice through real-life
                social scenarios.
              </li>
              <li>
                <strong>Feedback and Positive Reinforcement</strong> – Clients
                receive guidance and support.
              </li>
              <li>
                <strong>Homework and Real-Life Practice</strong> – Skills are
                applied in day-to-day environments.
              </li>
              <li>
                <strong>Problem-Solving and Coping Strategies</strong> – Tools
                for managing social challenges.
              </li>
            </ul>

            <h2 className="font-semibold text-xl">
              Skills Commonly Taught in SST Include:
            </h2>
            <ul className="list-disc pl-6">
