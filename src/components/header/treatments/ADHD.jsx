    ...
    <div className="w-full min-h-screen bg-white font-sans">
      ...
      <div className="px-10 lg:px-40 py-10">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">
          ADHD Therapy: Understanding and Managing Attention Deficit
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-3/4 space-y-6 text-gray-700">
            ...
            <p>
              ADHD is a neurodevelopmental condition that affects both children
              and adults. It is characterized by symptoms of inattention,
              hyperactivity, and impulsivity. Individuals may struggle with
              focus, organization, and impulse regulation, affecting various
              areas of life.
            </p>
            ...
            <ul className="list-disc pl-6">
              <li>
                <strong>Genetics:</strong> Tends to run in families
              </li>
              <li>
                <strong>Brain Structure:</strong> Differences in brain regions
                related to attention and impulse control
              </li>
              <li>
                <strong>Prenatal Factors:</strong> Exposure to substances or
                premature birth
              </li>
              <li>
                <strong>Neurotransmitter Imbalance:</strong> Issues with
            ...
            <ul className="list-disc pl-6">
              <li>
                <strong>Academics:</strong> Struggles with attention and task
                completion
              </li>
              <li>
                <strong>Work:</strong> Issues with time management and
                organization
              </li>
              <li>
                <strong>Relationships:</strong> Misunderstandings due to
                impulsivity or inattentiveness
              </li>
              <li>
                <strong>Emotional Regulation:</strong> Difficulty managing
                emotions and stress
              </li>
            </ul>
            ...
            <p>
              At [Your Clinic/Practice Name], we provide a comprehensive therapy
              plan to support individuals with ADHD through various
            ...
            <p>
              Includes questionnaires, behavioral observations, and interviews
              to accurately diagnose ADHD and identify co-occurring conditions.
            </p>
            ...
            <p>
              Helps challenge negative thinking patterns and improve emotional
              coping skills.
            </p>

            <h3 className="font-semibold text-lg">4. ADHD Coaching</h3>
            <p>
              Focused support for executive functioning—organization,
              goal-setting, planning, and follow-through.
            </p>

            <h3 className="font-semibold text-lg">
              5. Parent Training (for Children)
            </h3>
            <p>
              Educates parents to establish structured routines and reinforce
              positive behavior consistently.
            </p>

            <h3 className="font-semibold text-lg">6. Medication Management</h3>
            <p>
              When appropriate, stimulant and non-stimulant medications are
              prescribed and monitored by healthcare professionals.
            </p>

            <h3 className="font-semibold text-lg">7. Social Skills Training</h3>
            <p>
              Teaches children and adults how to interpret social cues, engage
              in positive interactions, and build better relationships.
            </p>
